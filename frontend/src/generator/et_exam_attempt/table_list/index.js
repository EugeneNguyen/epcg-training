...
import EtExamAttemptTerTable from './excel_table';
import EtExamAttemptTable from './table';

export default function TableEtExamAttemptList({where, excludeColumns, relationshipName}) {
  ...
  let refetch = null;
  const Table = isTerTable ? EtExamAttemptTerTable : EtExamAttemptTable;
  return (
