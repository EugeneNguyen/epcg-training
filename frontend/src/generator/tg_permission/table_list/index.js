...
import TgPermissionTerTable from './excel_table';
import TgPermissionTable from './table';

export default function TableTgPermissionList({where, excludeColumns, relationshipName}) {
  ...
  let refetch = null;
  const Table = isTerTable ? TgPermissionTerTable : TgPermissionTable;
  return (
    <div className="space-y-4">
      <Box title="List TgPermission">
        <Table
          limit={limit}
          offset={offset}
          where={where}
