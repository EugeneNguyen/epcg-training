...
export default function TgPermissionTable({limit, offset, didLoadData, onRefRefetch, where, excludeColumns, pathname, relationshipName}) {
  ...
  return (
    <Table>
      ...
      <TR>
        ...
        <TH
          hidden={excludeColumns.includes("groupId")}
          size=""
        >
          Group
        </TH>
