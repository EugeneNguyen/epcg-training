...
EtCourseTemplateExamQuestionTable.defaultProps = {
  excludeColumns: [],
};

export default function EtCourseTemplateExamQuestionTable({limit, offset, didLoadData, onRefRefetch, where, excludeColumns, pathname, relationshipName}) {
