...
EtCourseTemplateQuestionTagTable.defaultProps = {
  excludeColumns: [],
};

export default function EtCourseTemplateQuestionTagTable({limit, offset, didLoadData, onRefRefetch, where, excludeColumns, pathname, relationshipName, searchBy}) {
