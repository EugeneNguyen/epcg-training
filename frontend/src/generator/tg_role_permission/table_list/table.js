...
TgRolePermissionTable.defaultProps = {
  excludeColumns: [],
};

export default function TgRolePermissionTable({limit, offset, didLoadData, onRefRefetch, where, excludeColumns, pathname, relationshipName}) {
