...
import TgRolePermissionTerTable from './excel_table';
import TgRolePermissionTable from './table';

export default function TableTgRolePermissionList({where, excludeColumns, relationshipName}) {
  ...
  let refetch = null;
  const Table = isTerTable ? TgRolePermissionTerTable : TgRolePermissionTable;
  return (
    <div className="space-y-4">
      <Box title="List TgRolePermission">
        <Table
          limit={limit}
          offset={offset}
          where={where}
