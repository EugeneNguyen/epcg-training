...
TgUserPermissionTable.defaultProps = {
  excludeColumns: [],
};

export default function TgUserPermissionTable({limit, offset, didLoadData, onRefRefetch, where, excludeColumns, pathname, relationshipName}) {
