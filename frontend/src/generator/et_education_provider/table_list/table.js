...
EtEducationProviderTable.defaultProps = {
  excludeColumns: [],
};

export default function EtEducationProviderTable({limit, offset, didLoadData, onRefRefetch, where, excludeColumns, pathname, relationshipName, searchBy}) {
