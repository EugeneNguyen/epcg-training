...
TgPermissionGroupTable.defaultProps = {
  excludeColumns: [],
};

export default function TgPermissionGroupTable({limit, offset, didLoadData, onRefRefetch, where, excludeColumns, pathname, relationshipName}) {
